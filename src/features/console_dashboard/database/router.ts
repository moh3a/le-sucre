...
export const database_router = create_trpc_router({
  listTables: permission_procedure(PERMISSIONS.settings_read).query(() =>
    database_management_service.list_tables(),
  ),
  ...
  listJobs: permission_procedure(PERMISSIONS.settings_read).query(() =>
    database_management_service.get_job_definitions(),
  ),
