      ...
      <Card className="border shadow-md">
        <CardHeader className="flex flex-row items-center justify-between pb-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm">{t("targeting_subtitle")}</p>
          </div>
                ...
                >
                  ...
                  <div className="w-45">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value={TARGET_TYPE.customer_group}>
                          {t("target_customer_group")}
                        </SelectItem>
                        <SelectItem value={TARGET_TYPE.new_customer}>
                          {t("target_new_customer")}
                        </SelectItem>
                        <SelectItem value={TARGET_TYPE.returning_customer}>
                          {t("target_returning_customer")}
                        </SelectItem>
                  ...
                  <div className="min-w-50 flex-1">
                    ...
                    {rule.target_type === TARGET_TYPE.customer_group && (
                      <Field>
                        <FieldLabel className="text-xs">{t("customer_group_label")}</FieldLabel>
                        <Input
                          value={rule.target_value ?? ""}
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Field>
                          ...
                          >
                            ...
                            <SelectContent>
                              <SelectItem value="viewed_product">
                                {t("behavior_viewed_product")}
                              </SelectItem>
                              <SelectItem value="purchased_category">
                                {t("behavior_purchased_category")}
                              </SelectItem>
                              <SelectItem value="cart_abandoned">
                                {t("behavior_cart_abandoned")}
                              </SelectItem>
                            </SelectContent>
                          </Select>
                        </Field>
                        <Field>
                          <FieldLabel className="text-xs">{t("rule_value_label")}</FieldLabel>
                          <Input
                            value={rule.target_value ?? ""}
                            onChange={(e) => handleRuleChange(idx, "target_value", e.target.value)}
