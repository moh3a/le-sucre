      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm">{t("banners_subtitle")}</p>
          </div>
          <Button
        ...
        <CardContent>
          ...
          <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
              <DialogHeader>
                <DialogTitle>{selectedBanner ? t("edit_banner") : t("add_banner")}</DialogTitle>
              </DialogHeader>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <Field>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value={BANNER_TYPE.sidebar}>
                          {t("banner_type_sidebar")}
                        </SelectItem>
                        <SelectItem value={BANNER_TYPE.popup}>{t("banner_type_popup")}</SelectItem>
                        <SelectItem value={BANNER_TYPE.inline}>
                          {t("banner_type_inline")}
                        </SelectItem>
                        <SelectItem value={BANNER_TYPE.countdown_bar}>
                          {t("banner_type_countdown_bar")}
                        </SelectItem>
                        <SelectItem value={BANNER_TYPE.notification_bar}>
                          {t("banner_type_notification_bar")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </Field>
                  ...
                  <Field>
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setFormState({ ...formState, device_target: v as DeviceTarget })
                      }
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue />
                ...
                <div className="space-y-3">
                  <Field>
                    ...
                    <div className="flex gap-2">
                      ...
                      />
                      <MediaPickerDialog
                        onSelect={(media) => setFormState({ ...formState, image_url: media.url })}
                        trigger={
                          <Button
                            type="button"
                            variant="outline"
                            size="icon"
                            title={t("choose_from_media")}
                          >
                  ...
                  <Field>
                    ...
                    <div className="flex gap-2">
                      ...
                      />
                      <MediaPickerDialog
                        onSelect={(media) => setFormState({ ...formState, video_url: media.url })}
                        allowed_types={["video"]}
                        trigger={
                          <Button
                            type="button"
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  <Field>
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setFormState({ ...formState, link_target: v as "_self" | "_blank" })
                      }
                    >
                      <SelectTrigger className="h-9">
                        <SelectValue />
                    ...
                    {(["fr", "en", "ar"] as const).map((lang) => (
                      <TabsContent key={lang} value={lang} className="space-y-3 pt-2">
                        <div className="grid gap-3 md:grid-cols-2">
                          <Field>
                            <FieldLabel>
                              {t("overlay_headline", { lang: lang.toUpperCase() })}
                            </FieldLabel>
                            <Input
                          ...
                          <Field>
                            <FieldLabel>
                              {t("overlay_body", { lang: lang.toUpperCase() })}
                            </FieldLabel>
                            <Input
                        ...
                        <Field>
                          <FieldLabel>
                            {t("overlay_cta_label", { lang: lang.toUpperCase() })}
                          </FieldLabel>
                          <Input
