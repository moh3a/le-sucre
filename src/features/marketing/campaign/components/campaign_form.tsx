                    ...
                    render={({ field }) => (
                      <Field>
                        ...
                        <Select value={field.value} onValueChange={field.onChange}>
                          ...
                          <SelectContent>
                            <SelectItem value={CAMPAIGN_TYPE.homepage}>
                              {t("type_homepage")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_TYPE.seasonal}>
                              {t("type_seasonal")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_TYPE.flash_sale}>
                              {t("type_flash_sale")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_TYPE.targeted}>
                              {t("type_targeted")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_TYPE.banner}>{t("type_banner")}</SelectItem>
                            <SelectItem value={CAMPAIGN_TYPE.category}>
                              {t("type_category")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_TYPE.brand}>{t("type_brand")}</SelectItem>
                            <SelectItem value={CAMPAIGN_TYPE.landing_page}>
                              {t("type_landing_page")}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                    ...
                    render={({ field }) => (
                      <Field>
                        ...
                        <Select value={field.value} onValueChange={field.onChange}>
                          ...
                          <SelectContent>
                            <SelectItem value={CAMPAIGN_STATUS.draft}>
                              {t("status_draft")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_STATUS.scheduled}>
                              {t("status_scheduled")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_STATUS.active}>
                              {t("status_active")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_STATUS.paused}>
                              {t("status_paused")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_STATUS.ended}>
                              {t("status_ended")}
                            </SelectItem>
                            <SelectItem value={CAMPAIGN_STATUS.cancelled}>
                              {t("status_cancelled")}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        <Controller
                          ...
                          render={({ field }) => (
                            <Field>
                              <FieldLabel>
                                {t("display_title", { lang: lang.toUpperCase() })}
                              </FieldLabel>
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Field>
                              <FieldLabel>
                                {t("display_subtitle", { lang: lang.toUpperCase() })}
                              </FieldLabel>
                    ...
                    <Field>
                      ...
                      <div className="bg-background max-h-35 space-y-1 overflow-y-auto rounded-md border p-2">
                        {category_options.length === 0 ? (
                          <p className="text-muted-foreground p-1 text-xs">{t("no_category")}</p>
                        ) : (
                    ...
                    <Field>
                      ...
                      <div className="bg-background max-h-35 space-y-1 overflow-y-auto rounded-md border p-2">
                        {!activeBrands || activeBrands.length === 0 ? (
                          <p className="text-muted-foreground p-1 text-xs">{t("no_brand")}</p>
                        ) : (
                    ...
                    render={({ field }) => (
                      <Field>
                        ...
                        <Input
                          {...field}
                          value={field.value ?? ""}
                          placeholder={t("test_slug_placeholder")}
                        />
                      </Field>
                    )}
                  />
