      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <div>
            ...
            <p className="text-muted-foreground text-sm">{t("sections_subtitle")}</p>
          </div>
          <Button
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          ...
                          <Badge
                            variant="secondary"
                            className="bg-chiffon/60 text-primary-foreground text-[10px]"
                          >
            ...
            <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
              ...
              <form onSubmit={handleSave} className="space-y-4 pt-2">
                <div className="grid gap-4 md:grid-cols-3">
                  <Field className="md:col-span-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value={SECTION_TYPE.product_grid}>
                          {t("section_type_product_grid")}
                        </SelectItem>
                        <SelectItem value={SECTION_TYPE.product_carousel}>
                          {t("section_type_product_carousel")}
                        </SelectItem>
                        <SelectItem value={SECTION_TYPE.category_showcase}>
                          {t("section_type_category_showcase")}
                        </SelectItem>
                        <SelectItem value={SECTION_TYPE.brand_showcase}>
                          {t("section_type_brand_showcase")}
                        </SelectItem>
                        <SelectItem value={SECTION_TYPE.banner_row}>
                          {t("section_type_banner_row")}
                        </SelectItem>
                        <SelectItem value={SECTION_TYPE.countdown}>
                          {t("section_type_countdown")}
                        </SelectItem>
                        <SelectItem value={SECTION_TYPE.text_block}>
                          {t("section_type_text_block")}
                        </SelectItem>
                        <SelectItem value={SECTION_TYPE.video}>
                          {t("section_type_video")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </Field>
                ...
                <div className="space-y-4 border-t pt-4">
                  <h4 className="mb-2 text-sm font-semibold">{t("section_config_label")}</h4>
                  ...
                  {(formState.section_type === "product_grid" ||
                    ...
                    <div className="space-y-4">
                      <Field>
                        ...
                        <div className="bg-background max-h-35 space-y-1 overflow-y-auto rounded-md border p-2">
