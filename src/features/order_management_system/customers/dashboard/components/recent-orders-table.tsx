          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-muted-foreground border-b text-left">
                <th className="pr-4 pb-2 font-medium">{columnLabels.order}</th>
                <th className="pr-4 pb-2 font-medium">{columnLabels.date}</th>
                <th className="pr-4 pb-2 font-medium">{columnLabels.status}</th>
            ...
            <tbody>
              {orders.map((order) => (
                <tr key={order.id} className="border-b last:border-0">
                  ...
                  <td className="text-muted-foreground py-3 pr-4">{order.date}</td>
                  <td className="py-3 pr-4">
