...
import { AccountNavCard } from "@/features/order_management_system/customers/dashboard/components/account-nav-card";
import { RecentOrdersTable } from "@/features/order_management_system/customers/dashboard/components/recent-orders-table";
          ...
          <CardContent>
            {data.recent_activity.length > 0 ? (
              ...
              <div className="border-muted relative border-l-2 pl-4">
                <div className="bg-primary absolute top-1 -left-2.25 size-4 rounded-full" />
...
function AnonymousDashboard({
  ...
  return (
    <div className="container mx-auto space-y-8">
      {/* CTA BANNER */}
      <section>
        <Card className="border-lemon-lime/50 from-lemon-chiffon/20 to-cream/50 bg-linear-to-br">
          <CardContent className="flex flex-col items-center gap-4 py-8 text-center">
            ...
            <Button size="lg" className="gap-2" onClick={handleCtaClick}>
