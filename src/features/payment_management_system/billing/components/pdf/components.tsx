...
export const FlexRow: React.FC<BoxProps> = ({ style, children }) => (
  <View style={[flex_row, ...(Array.isArray(style) ? style : style ? [style] : [])]}>
    {children}
  </View>
);

export const FlexCol: React.FC<BoxProps> = ({ style, children }) => (
  <View style={[flex_col, ...(Array.isArray(style) ? style : style ? [style] : [])]}>
    {children}
  </View>
);
...
export const BoldText: React.FC<{
  ...
  <Text style={[bold_text, ...(Array.isArray(style) ? style : style ? [style] : [])]}>
    {children}
  </Text>
);
