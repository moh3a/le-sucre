              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>{t("void_confirm_description")}</AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="text-muted-foreground border-b text-left text-xs">
                        <th className="pr-4 pb-2 font-medium">{t("reference")}</th>
                        <th className="pr-4 pb-2 font-medium">{t("product")}</th>
                        <th className="pr-4 pb-2 text-right font-medium">{t("qty")}</th>
                        <th className="pr-4 pb-2 text-right font-medium">{t("unit_price")}</th>
                        <th className="pr-4 pb-2 text-right font-medium">{t("vat")}</th>
                ...
                {invoice.paid_at && (
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-600">
                      {formatDate(invoice.paid_at, { month: "short" })}
                    </span>
                  </div>
                )}
              </CardContent>
