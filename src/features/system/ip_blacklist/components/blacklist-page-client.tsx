              ...
              <DropdownMenuItem
                onClick={() =>
                  optimisticToggle({
                    ...
                    updater: (old: { entries: BlacklistRow[] } | undefined) =>
                      old
                        ? {
                            ...old,
                            entries: old.entries.map((e) =>
                              e.id === row.original.id ? { ...e, is_active: !e.is_active } : e,
                            ),
                          }
                        : { entries: [] as BlacklistRow[] },
  ...
  return (
    ...
    >
      <>
          ...
          stats={
            <StatsGrid
              ...
              items={[
                ...
                {
                  label: t("stat_inactive"),
                  value: stats?.inactive ?? 0,
                  icon: XCircle,
                  color: "default",
                },
                {
                  label: t("stat_expiring_soon"),
        ...
        <BlacklistAddDialog open={create_open} on_open_change={setCreateOpen} />
