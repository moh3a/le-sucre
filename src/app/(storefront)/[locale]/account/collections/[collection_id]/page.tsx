...
export default async function CustomerCollectionDetailPage({
  params,
}: {
  params: Promise<{ locale: string; collection_id: string }>;
}) {
  const { locale, collection_id } = await params;
    ...
    <>
      <StorefrontBreadcrumbs
        items={[
          ...
          { label: tBc("my_collections"), href: "/account/collections" },
          { label: tBc("detail") },
        ]}
      />
