...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="font-heading mb-6 text-[clamp(1.44rem,2.5vw,2rem)] leading-tight font-normal tracking-tight">
      {children}
    </h2>
  );
}
...
function RowLabel({ children }: { children: React.ReactNode }) {
  return <div className="text-muted-foreground -mb-1 w-full text-xs font-semibold">{children}</div>;
}
...
export default function ComponentsPage() {
  ...
  return (
    <div className="mx-auto max-w-300 px-8 py-12 pb-24">
      {/* Header */}
      <header className="border-border mb-14 flex items-start justify-between border-b pb-6">
        <div>
          <h1 className="font-heading text-[clamp(2rem,3.5vw,3rem)] leading-none font-normal tracking-tight">
      ...
      <section className="mb-14">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <ButtonGroup>
            ...
            <Button size="sm">
              <Scissors className="size-3.5" /> Couper
            </Button>
            <Button size="sm">
      ...
      <section className="mb-14">
        ...
        <div className="flex flex-col gap-3">
          <Alert>
            ...
            <div>
              <AlertTitle>Nouvelle commande reçue</AlertTitle>
              <AlertDescription>
                La commande #2847 a été passée par un client à Alger.
              </AlertDescription>
            </div>
          </Alert>
          <Alert variant="success">
            ...
            <div>
              ...
              <AlertDescription>
                Moule Silicone 12 Cavités a été ajouté au catalogue.
              </AlertDescription>
            </div>
          </Alert>
          <Alert variant="warning">
            ...
            <div>
              ...
              <AlertDescription>
                Boîte Kraft 20×20×10 — seulement 12 articles restants.
              </AlertDescription>
            </div>
          </Alert>
          <Alert variant="destructive">
            ...
            <div>
              ...
              <AlertDescription>
                Le paiement Chargily a échoué pour la commande #2831.
              </AlertDescription>
            </div>
          </Alert>
        </div>
      ...
      <section className="mb-14">
        ...
        <div className="mb-5 grid grid-cols-[repeat(auto-fill,minmax(260px,1fr))] gap-4">
        ...
        <div className="mb-5">
          <div className="flex max-w-135 flex-col gap-1.5">
        ...
        <div className="mb-5">
          ...
          <div className="mt-2 max-w-90">
            ...
            <div className="text-muted-foreground mt-1.5 text-xs">Valeur : {sliderValue[0]}</div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-5">
          ...
          <div className="flex items-center gap-2">
            <Switch
              ...
              onCheckedChange={(v) => setSwitchStates((s) => ({ ...s, email: v }))}
            />
            <span className="text-sm">Notification email</span>
          </div>
          <div className="flex items-center gap-2">
            <Switch
              checked={switchStates.edition}
              onCheckedChange={(v) => setSwitchStates((s) => ({ ...s, edition: v }))}
            />
      ...
      <section className="mb-14">
        ...
        <h3 className="text-muted-foreground mb-2.5 text-sm font-semibold">Default variant</h3>
        <Tabs defaultValue="general">
          ...
          <TabsContent value="general" className="text-muted-foreground py-3 text-sm">
            Contenu de l&apos;onglet Général — informations produit, prix, description.
          </TabsContent>
          <TabsContent value="variants" className="text-muted-foreground py-3 text-sm">
            Gestion des variantes — taille, couleur, materiau.
          </TabsContent>
          <TabsContent value="inventory" className="text-muted-foreground py-3 text-sm">
            Suivi des stocks, alertes de stock bas, prévisions.
          </TabsContent>
          <TabsContent value="media" className="text-muted-foreground py-3 text-sm">
            Photos, vidéos, galeries du produit.
          </TabsContent>
        </Tabs>
        <h3 className="text-muted-foreground mt-8 mb-2.5 text-sm font-semibold">Line variant</h3>
        <Tabs defaultValue="orders">
          ...
          <TabsContent value="orders" className="text-muted-foreground py-3 text-sm">
            Historique des commandes récentes avec statut de livraison.
          </TabsContent>
          <TabsContent value="payments" className="text-muted-foreground py-3 text-sm">
            Détails de paiement et méthodes utilisées.
          </TabsContent>
          <TabsContent value="shipping" className="text-muted-foreground py-3 text-sm">
            Suivi d&apos;expédition et transporteurs.
          </TabsContent>
        </Tabs>
      </section>
      ...
      <section className="mb-14">
        ...
        <Accordion type="single" collapsible className="max-w-135">
          <AccordionItem value="shipping">
            <AccordionTrigger>Politique de livraison</AccordionTrigger>
            <AccordionContent>
              Livraison gratuite à Alger pour les commandes supérieures à 5000 DA. Délai : 2-3 jours
              ouvrables.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="returns">
            ...
            <AccordionContent>
              Retour gratuit sous 14 jours. Le produit doit être dans son emballage d&apos;origine.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="payment">
            <AccordionTrigger>Moyens de paiement</AccordionTrigger>
            <AccordionContent>
              Paiement à la livraison, CCP/BaridiMob, et Chargily Pay (CIB/Edahabia).
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
      ...
      <section className="mb-14">
        ...
        <Collapsible className="border-border max-w-135 rounded-lg border p-4">
          ...
          <div className="text-muted-foreground mt-1 text-sm">
            @pedro a été forké 3 fois cette semaine.
          </div>
          <CollapsibleContent className="mt-3 space-y-2">
            ...
            <div className="border-border rounded-md border px-4 py-2 text-sm">@stitches/react</div>
          </CollapsibleContent>
        </Collapsible>
      </section>
      ...
      <section className="mb-14">
        ...
        <div className="mb-5 max-w-100">
          <div className="mb-1.5 flex justify-between">
            <span className="text-sm font-medium">Stock restant</span>
            <span className="text-muted-foreground text-sm">72%</span>
          </div>
          <Progress value={72} />
        </div>
        <div className="mb-8 max-w-100">
          <div className="mb-1.5 flex justify-between">
        ...
        <h3 className="text-muted-foreground mb-2.5 text-sm font-semibold">Skeleton loaders</h3>
      ...
      <section className="mb-14">
        ...
        <div className="flex flex-col gap-4">
          <div>
            <div className="text-muted-foreground mb-2 text-xs font-semibold">Default (1 step)</div>
            <Rating value={ratingValue} onValueChange={setRatingValue}>
              {Array.from({ length: 5 }, (_, i) => (
                <RatingItem key={i} index={i} />
              ))}
            </Rating>
            <div className="text-muted-foreground mt-1.5 text-xs">Note : {ratingValue}/5</div>
          </div>
          <div>
            <div className="text-muted-foreground mb-2 text-xs font-semibold">Read-only</div>
          ...
          <div>
            <div className="text-muted-foreground mb-2 text-xs font-semibold">Half steps</div>
        ...
        <div className="border-border bg-card overflow-hidden rounded-lg border">
          <Table>
            ...
            <TableBody>
              {[
                {
                  name: "Moule Silicone 12 Cavités",
                  cat: "Outils",
                  price: "2,500 DA",
                  stock: 142,
                ...
                {
                  name: "Colorant Alimentaire Set 6",
                  cat: "Ingrédients",
                  price: "850 DA",
                  stock: 0,
      ...
      <section className="mb-14">
        ...
        <ScrollArea className="border-border h-50 w-90 rounded-lg border p-4">
          <div className="space-y-4 text-sm">
            <p>
              Les ingrédients de base pour la pâtisserie algérienne incluent la farine, le sucre,
              les œufs, et le beurre.
            </p>
            <p>
              Les moules silicone sont idéaux pour la pâtisserie car ils permettent une démoulage
              facile et sont résistants à la chaleur.
            </p>
            <p>
              Le packaging est essentiel pour la présentation des gâteaux et pâtisseries en
              boutique.
            </p>
            <p>
              Les colorants alimentaires naturels sont de plus en plus demandés par les clients
              soucieux de leur santé.
            </p>
            <p>
              La livraison à domicile est un service apprécié par les clients d&apos;Alger et des
              grandes villes.
            </p>
            <p>
              Les outils de décoration permettent de créer des motifs élégants sur les gâteaux et
              tartes.
            </p>
          </div>
        </ScrollArea>
      ...
      <section className="mb-14">
        ...
        <div className="max-w-135">
          <Stepper
            ...
            onValueChange={(value) => setStepperValue(parseInt(value))}
          >
            <StepperItem value="info">
              ...
              <div className="hidden sm:block">
                <StepperTitle>Informations</StepperTitle>
                <StepperDescription>Données produit</StepperDescription>
              </div>
            </StepperItem>
            <StepperSeparator />
            <StepperItem value="media">
              ...
              <div className="hidden sm:block">
                <StepperTitle>Médias</StepperTitle>
                <StepperDescription>Photos & vidéos</StepperDescription>
              </div>
            </StepperItem>
            <StepperSeparator />
            <StepperItem value="pricing">
              ...
              <div className="hidden sm:block">
                <StepperTitle>Prix</StepperTitle>
                <StepperDescription>Tarification</StepperDescription>
              </div>
            </StepperItem>
            <StepperSeparator />
            <StepperItem value="confirm">
              ...
              <div className="hidden sm:block">
                ...
                <StepperDescription>Publier</StepperDescription>
              </div>
            </StepperItem>
            <StepperContent
              value="info"
              className="border-border text-muted-foreground mt-4 rounded-lg border p-4 text-sm"
            >
              Étape 1 — Remplissez les informations de base du produit (nom, description,
              catégorie).
            </StepperContent>
            <StepperContent
              value="media"
      ...
      <section className="mb-14">
        ...
        <Calendar
          ...
          className="border-border w-fit rounded-lg border"
        />
      </section>
      ...
      <section className="mb-14">
        ...
        <div className="mb-6 flex flex-wrap gap-3">
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Cette action est irréversible. Le produit sera définitivement supprimé du
                  catalogue.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
          ...
          <Sheet>
            <SheetTrigger asChild>
              <Button size="sm">Ouvrir le panneau</Button>
            </SheetTrigger>
            <SheetContent side={sheetSide}>
              <SheetHeader>
                <SheetTitle>Détails du produit</SheetTitle>
                <SheetDescription>
                  Moule Silicone 12 Cavités — Informations complètes.
                </SheetDescription>
              </SheetHeader>
              <div className="text-muted-foreground space-y-3 py-4 text-sm">
                <p>
                  Le moule silicone 12 cavités est idéal pour la fabrication de gâteaux et tartes
                  individuelles.
                </p>
                <p>Prix : 2,500 DA</p>
        ...
        <div className="flex items-center gap-2">
          <span className="text-muted-foreground text-xs">Sheet side :</span>
          {(["right", "left", "top", "bottom"] as const).map((side) => (
            <Button
              key={side}
              size="xs"
              variant={sheetSide === side ? "default" : "outline"}
      ...
      <section className="mb-14">
        ...
        <Drawer>
          <DrawerTrigger asChild>
            <Button size="sm">Ouvrir le tiroir</Button>
          </DrawerTrigger>
          <DrawerContent>
            <DrawerHeader>
        ...
        <div className="mb-6 flex flex-wrap items-center gap-4">
          ...
          <Popover>
            ...
            <PopoverContent className="w-64">
              <div className="mb-1 text-sm font-medium">Détails du produit</div>
              <p className="text-muted-foreground text-xs">
                Moule Silicone 12 Cavités — 2,500 DA. En stock.
              </p>
            </PopoverContent>
          </Popover>
          <DropdownMenu>
        ...
        <CommandDialog open={commandOpen} onOpenChange={setCommandOpen}>
          ...
          <CommandList>
            ...
            <CommandGroup heading="Produits">
              <CommandItem>
                <PackageOpen className="size-4" /> Moule Silicone 12 Cavités
              </CommandItem>
              <CommandItem>
                <PackageOpen className="size-4" /> Farine T55 Bio 1kg
              </CommandItem>
              <CommandItem>
                <PackageOpen className="size-4" /> Boîte Kraft 20×20×10
              </CommandItem>
            </CommandGroup>
            <CommandSeparator />
            <CommandGroup heading="Actions">
              <CommandItem>
                <Plus className="size-4" /> Créer un produit
              </CommandItem>
              <CommandItem>
                <User className="size-4" /> Ajouter un client
              </CommandItem>
            </CommandGroup>
          </CommandList>
        </CommandDialog>
      ...
      <section className="mb-14">
        ...
        <div className="flex flex-wrap gap-2.5">
          <Button
            ...
            size="sm"
            onClick={() =>
              toast.success("Produit créé", { description: "Ajouté au catalogue avec succès" })
            }
          >
            Succès
          </Button>
          <Button
            variant="outline"
            size="sm"
            onClick={() => toast.error("Erreur", { description: "Une erreur est survenue" })}
          >
            Erreur
          </Button>
          <Button
            ...
            size="sm"
            onClick={() =>
              toast.warning("Stock bas", { description: "Il ne reste que 12 articles" })
            }
          >
            Alerte
          </Button>
          <Button
            variant="outline"
            size="sm"
            onClick={() => toast.info("Nouvelle commande", { description: "Commande #2847 reçue" })}
          >
            Info
          </Button>
        </div>
        ...
        <Card className="max-w-120">
          <Empty>
            <EmptyHeader>
              ...
              <EmptyDescription>
                Commencez par ajouter des produits à votre catalogue pour les vendre en ligne.
              </EmptyDescription>
            </EmptyHeader>
            <EmptyContent>
              <Button size="sm">
          ...
          <div>
            ...
            <AlertDescription>
              ...
              <Button
                variant="link"
                size="sm"
                className="text-destructive ml-1 h-auto p-0 underline"
              >
                Réessayer
              </Button>
            </AlertDescription>
      ...
      <section className="mb-14">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex flex-col items-center justify-center py-6 text-center">
                <Spinner className="text-muted-foreground mb-3 size-6" />
        ...
        <div className="border-border bg-card max-w-135 overflow-hidden rounded-lg border">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead>Produit</TableHead>
      ...
      <section className="mb-14">
          ...
          <Card>
            <Empty>
              <EmptyHeader>
                ...
                <EmptyDescription>
                  Moule Silicone 12 Cavités a été ajouté au catalogue avec succès.
                </EmptyDescription>
              </EmptyHeader>
              <EmptyContent>
                <div className="flex gap-2">
                  <Button size="sm">Voir le produit</Button>
                  <Button size="sm" variant="outline">
                    Créer un autre
                  </Button>
                </div>
          ...
          <Card>
            <Empty>
              <EmptyHeader>
                ...
                <EmptyDescription>
                  La commande #2847 a été confirmée et est en cours de traitement.
                </EmptyDescription>
              </EmptyHeader>
              <EmptyContent>
                <Button size="sm">Voir la commande</Button>
              </EmptyContent>
            </Empty>
          </Card>
          <Card>
            <Empty>
              <EmptyHeader>
                ...
                <EmptyDescription>
                  Le paiement de 2,500 DA a été traité avec succès via Chargily.
                </EmptyDescription>
              </EmptyHeader>
              <EmptyContent>
                <Button size="sm" variant="outline">
        ...
        <Alert variant="success">
          ...
          <div>
            ...
            <AlertDescription>Les modifications ont été sauvegardées avec succès.</AlertDescription>
          </div>
        </Alert>
